...
public class UserAuthService {
     ...
     *
     * @return {@link java.lang.String String} format of {@link com.auth0.jwt.JWT JWT}
     */
    @Transactional
    public String registerUser(UserSignInDto.UserRegistrationDto userRegistrationDto) {
//        check if email or password is registered
        ...
        return jwtTokenGeneratorService.generateUserAccessToken(userAuth);
    }
    ...
    public Map<String, String> signIn(UserSignInDto userSignInDto, HttpServletResponse response) {

...
public class UserAuthController {
    ...
    public ResponseEntity<Map<String, String>> signIn(@Valid @RequestBody UserSignInDto userSignInDto, HttpServletResponse response) {
...
//returns user JWT
    ...
    public String registerUser(@Valid @RequestBody UserSignInDto.UserRegistrationDto userRegistrationDto) {

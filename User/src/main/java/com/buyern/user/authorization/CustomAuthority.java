...
class CustomAuthority implements GrantedAuthority {
    ...
    Long entityId;
    /**
     * if value is zero, that means the user can perform the specified {@link com.buyern.inventory.authorization.CustomAuthority#permission action} on all tools
     */
    Long tool;
    /**
     * if value is {@link Permission#ALL Action.ALL}, that means the user
     * can perform all action on the specified {@link com.buyern.inventory.authorization.CustomAuthority#tool tool }
     */
